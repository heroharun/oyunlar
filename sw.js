...
const PAKET = ['./', 'manifest.json',
  ...
  '2048/', '2248/', 'aklin-ters-kosesi/', 'anka/', 'arkeolog/', 'ates-su/', 'ayna-araba/', 'bedesten/', 'bereket/', 'bit-pazari/', 'blok-yagmuru/', 'boltbloom/', 'boyama/', 'buz-kule/', 'cop-basket/', 'denge-ustasi/', 'dini-tabu/', 'dondurmaci/', 'donerci/', 'duble-yol/', 'fatihin-toplari/', 'gokyuzu-kartali/', 'hafizlik-ajandasi/', 'hal/', 'hikmet-yolculari/', 'hokey/', 'isikli-hafiza/', 'itfaiye-komutani/', 'iyilik-adasi/', 'kedi/', 'kelime-bahcesi/', 'kelime-yorungesi/', 'kelime/', 'kim-alim/', 'kiz-giydirme/', 'kos-zipla/', 'kuafor-salonum/', 'kuafor/', 'kule/', 'kutlu-yolculuk/', 'maden/', 'mayin/', 'mekan/', 'meyve/', 'minik-asci/', 'minik-cicekci/', 'minik-modaci/', 'minik-nalbur/', 'minik-sifaci/', 'namaz-vakti/', 'nur-bahcesi/', 'nur-tahti/', 'ormanci/', 'park/', 'penalti/', 'piyano/', 'postane/', 'renk-tuzagi/', 'sekerci-bizim/', 'sikke-sirala/', 'sudoku/', 'taktak/', 'tava-tabak/', 'tesettur-butigi/', 'teskilat/dist/', 'topac-sumo/', 'tugla-kiran/', 'usta-sofor/', 'yikim/', 'yilan/', 'yorunge/', 'yumurta/'];
